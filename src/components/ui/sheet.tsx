...
>(({ side = 'right', className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    >
      {children}
      <SheetPrimitive.Close className="absolute right-2 top-2 opacity-70 outline-none ring-offset-white transition-opacity hover:opacity-100 focus:ring-2 focus:ring-soft-lime focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-white">
        <X className="h-4 w-4" />
